...
<article class="pp-container">
    ...
    <section class="pp-section">
        <h3 class="pp-section-ttl">第２条（プライバシー情報の収集方法）</h3>
    ...
    <section class="pp-section">
        <h3 class="pp-section-ttl">第３条（個人情報を収集・利用する目的）</h3>
    ...
    <section class="pp-section">
        <h3 class="pp-section-ttl">第４条（個人情報の第三者提供）</h3>
    ...
    <section class="pp-section">
        <h3 class="pp-section-ttl">第５条（個人情報の開示）</h3>
    ...
    <section class="pp-section">
        <h3 class="pp-section-ttl">第６条（個人情報の訂正および削除）</h3>
    ...
    <section class="pp-section">
        <h3 class="pp-section-ttl">第７条（個人情報の利用停止等）</h3>
